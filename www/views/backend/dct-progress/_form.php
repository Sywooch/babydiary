...
<div class="dct-progress-form">
    ...
    <?= $form->field($model, 'dct_progress_id')->textInput(['disabled'=>'disabled']) ?>
    ...
    <table class="table table-bordered">
        ...
        <?php foreach($languages as $index => $lang) :?>
            <tr>
                <td>
                    <?=$index + 1;?><?=Html::input('hidden', $index . '[dct_progress_loc_id]', (isset($modelLoc[$lang['id']])) ? $modelLoc[$lang['id']]['id'] : '');?>
                </td>
                <td>
