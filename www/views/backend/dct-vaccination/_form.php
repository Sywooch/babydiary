...
<div class="dct-vaccination-form">
    ...
    <?= $form->field($model, 'dct_vaccination_id')->textInput(['disabled'=>'disabled']) ?>
    ...
    <table class="table table-bordered">
        ...
        <?php foreach($languages as $index => $lang) :?>
            <tr>
                <td>
                    <?=$index + 1;?><?=Html::input('hidden', $index . '[dct_vaccination_loc_id]', (isset($modelLoc[$lang['id']])) ? $modelLoc[$lang['id']]['id'] : '');?>
                </td>
                <td>
                ...
                <td>
                    <?=Html::input('genitive_text', $index . '[genitive_text]', (isset($modelLoc[$lang['id']])) ? $modelLoc[$lang['id']]['genitive_text'] : '', ['class' => 'form-control']);?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
