...
<div class="dct-solid-food-form">
    ...
    <?= $form->field($model, 'dct_solid_food_id')->textInput(['disabled'=>'disabled']) ?>
    ...
    <table class="table table-bordered">
        ...
        <?php foreach($languages as $index => $lang) :?>
            <tr>
                <td>
                    <?=$index + 1;?><?=Html::input('hidden', $index . '[dct_solid_food_loc_id]', (isset($modelLoc[$lang['id']])) ? $modelLoc[$lang['id']]['id'] : '');?>
                </td>
                <td>
